...
# 输入文件路径
input_file_path = '/home/zhangxuanming/cceval/tmp/crosscodeeval_testrun/New_line_completion_oracle_openai_cosine_sim.jsonl'  # 请替换为实际路径
# 输出文件路径
output_file_path = '/home/zhangxuanming/cceval/tmp/crosscodeeval_testrun/New_evaluation.jsonl'  # 请替换为实际路径
